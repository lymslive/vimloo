...
" load: 
function! jp#System#Process#load() abort "{{{
  let s:Prelude = package#import('jp#Prelude')
  let s:String = package#import('jp#Data#String')
  call s:register('jp#System#Process#Vimproc')
  call s:register('jp#System#Process#System')
endfunction "}}}
...
function! s:register(name) abort
  let client = package#import(a:name)
