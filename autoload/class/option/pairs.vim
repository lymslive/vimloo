...
" CTOR: 4 arguments
function! class#option#pairs#ctor(this, ...) abort "{{{
    if a:0 < 3
        echoerr '[class#option#pairs] expcet at least 3 arguments: (Char, Name, Desc)'
        return
    endif
    call class#option#single#ctor(a:this, a:1, a:2, a:3)
    if a:0 > 3
